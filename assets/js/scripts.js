    ...
    $(function () {
        ...
        function toggleLocalStorageItem() {
            if (isLight()) {
                ...
                $(".navbar .logo img , footer .logo img").attr("src", "assets/imgs/logo-Inspler-white.png");
            } else {
        ...
        $("body.light .navbar .logo img , body.light footer .logo img").attr("src", "assets/imgs/logo-Inspler-white.png");
